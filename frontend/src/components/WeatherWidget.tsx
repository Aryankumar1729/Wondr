...
export default function WeatherWidget({ 
  ...
  if (loading) {
    return (
      <div className="absolute bottom-6 left-1/2 -translate-x-1/2 w-[90%] max-w-[800px] bg-white rounded-3xl shadow-[0_10px_40px_rgba(0,0,0,0.1)] p-8 z-[2000] flex justify-center items-center h-[300px]">
  ...
  return (
    <div className="absolute bottom-6 left-1/2 -translate-x-1/2 w-[90%] max-w-[800px] bg-white rounded-3xl shadow-[0_20px_60px_rgba(0,0,0,0.15)] overflow-hidden z-[2000] border border-gray-100">
      {/* Header */}
      ...
      <div className="p-6">
        ...
        {/* Hourly Timeline */}
        <div className="flex justify-between items-center px-2 mb-10 overflow-x-auto gap-4">
        ...
        <div className="pt-8 border-t border-gray-100">
          <h3 className="text-xs font-bold text-gray-400 tracking-widest uppercase mb-4">ACCOMMODATION</h3>
